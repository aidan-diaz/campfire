...
import { teamMembers, getCompanyById, Job, HiringStage } from '../../data/mockData';
...
export default function JobForm() {
  const { currentTeamMember, createJob } = useApp();
  ...
  return (
    <div className="min-h-screen" style={{ background: '#0a0a14' }}>
      <div className="px-6 pt-8 pb-6 border-b" style={{ borderColor: 'rgba(124,58,237,0.1)' }}>
        <button onClick={() => navigate('/recruiter')} className="flex items-center gap-1.5 mb-4" style={{ fontSize: 13, color: '#64748b' }}>

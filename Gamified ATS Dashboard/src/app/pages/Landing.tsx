...
import { teamMembers, applicants } from '../data/mockData';
...
export default function Landing() {
  const { setPersona, setCurrentApplicant, setCurrentTeamMember } = useApp();
  ...
  const handleTeamMemberSelect = (id: string) => {
    ...
    if (selectedRole === 'recruiter') navigate('/recruiter');
